...
import { Feedback, GoogleLoginResponse, UserInfo } from '../../misc/type'
import { setCredentials } from '../../components/user/userSlice'

export default function LogInWithGoogle({ feedback }: { feedback: Feedback }) {
  ...
  const login = useGoogleLogin({
    onSuccess: async (tokenResponse) => {
      ...
      setTimeout(() => redirect('./account'), 3000)
    },
